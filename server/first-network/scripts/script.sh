...
CC_SRC_PATH="github.com/chaincode/voting/voting/"
if [ "$LANGUAGE" = "node" ]; then
	CC_SRC_PATH="/opt/gopath/src/github.com/chaincode/voting/"
fi
...
installChaincode2 1 1
echo "Install Chaincode on peer1.org2..."
installChaincode 1 2
installChaincode2 1 2

# Instantiate chaincode on all peer
